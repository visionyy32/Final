  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">About TrackFlow</h1>
        <p className="text-xl text-gray-600">Your trusted partner in reliable parcel delivery across Kenya</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 mb-8 hover:shadow-xl transition-shadow">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <h3 className="text-2xl font-semibold text-blue-600 mb-4">CEDRICK KIPKURUI</h3>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-sm text-gray-600">Computer Science Background</span>
              </div>
            </div>
          </div>
          <div className="text-center">
            <div className="w-48 h-48 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-white text-6xl font-bold">CK</span>
            </div>
            <p className="text-gray-600">CEDRICK KIPKURUI</p>
      ...
      {/* Why Choose Us */}
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-8 mb-8 text-white hover:shadow-xl transition-shadow">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-blue-100">Express delivery options with guaranteed delivery times</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-blue-100">Advanced tracking and insurance for all parcels</p>
          </div>
          <div className="text-center">
            <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-blue-100">Serving all major cities and towns across Kenya</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Our Numbers</h2>
        <div className="grid md:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-3xl font-bold text-blue-600 mb-2">50,000+</div>
            <div className="text-gray-600">Parcels Delivered</div>
          </div>
          <div className="text-center">
